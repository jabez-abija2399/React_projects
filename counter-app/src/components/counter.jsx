...
class Counter extends Component {
  // Define Counter class component
  render() {
    // Render method to display the component
    return (
      <div className="row">
        {" "}
        {/* Container div with Bootstrap row class */}
        <div className="col-1">
          {" "}
          {/* Column with width 1 */}
          ...
          {/* Span element with dynamic classes and text */}
        </div>
        <div className="col">
          {" "}
          {/* Column for buttons */}
  ...
  getBadgeClasses() {
    // Method to get dynamic classes for badge
  ...
  formatCount() {
    // Method to format the counter value
